        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 12 }}>
          <button
            ...
            style={{
              ...
              background: triageRunning ? "#21262d" : "transparent",
              color: "var(--yellow)",
          ...
          <button
            ...
            style={{
              ...
              background: guidedRunning ? "#21262d" : "transparent",
              color: "var(--accent)",
            ...
            {actions.map((a) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: 4,
                  border: "1px solid var(--border)",
                  background: runningAction === a.action ? "#21262d" : "transparent",
                  color: "var(--text)",
                  ...
                  <td>
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: 4,
                        border: "1px solid var(--border)",
                        background: compareAId === s.session_id ? "#21262d" : "transparent",
                        color: "var(--muted)",
                        cursor: "pointer",
                        fontSize: 12,
                      }}
                  ...
                  <td>
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: 4,
                        border: "1px solid var(--border)",
                        background: compareBId === s.session_id ? "#21262d" : "transparent",
                        color: "var(--muted)",
                        cursor: "pointer",
                        fontSize: 12,
                      }}
