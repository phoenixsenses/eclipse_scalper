# run-bot-eth-test.ps1
# Experimental ETH-only profile (not for live unless validated)

# Safety first (set to 1 for dry run)
$env:SCALPER_DRY_RUN = "0"

# Core symbols / signal profile
$env:ACTIVE_SYMBOLS = "ETHUSDT"
$env:SCALPER_SIGNAL_PROFILE = "micro"
$env:SCALPER_SIGNAL_DIAG = "0"

# Enhanced signal stack
$env:SCALPER_ENHANCED = "1"
$env:SCALPER_ENH_TREND_1H = "1"
$env:SCALPER_DEBUG_LOOSE = "0"

# Quality mode for ETH
$env:SCALPER_QUALITY_MODE = "1"
$env:SCALPER_QUALITY_CONF_MIN = "0.60"

# ETH-specific gates (tunable)
$env:SCALPER_ATR_PCT_MIN_ETH = "0.003"
$env:SCALPER_VWAP_BASE_DIST_ETH = "0.010"
$env:SCALPER_VOL_Z_TH_ETH = "1.3"
$env:SCALPER_VOL_Z_SOFT_TH_ETH = "0.5"
$env:SCALPER_RANGE_ATR_MIN_ETH = "0.5"
$env:SCALPER_VOL_MIN_MULT_ETH = "0.65"

# Entry loop (full)
$env:ENTRY_LOOP_MODE = "full"
$env:ENTRY_RESPECT_KILL_SWITCH = "1"

# Sizing + leverage (safe)
...
$env:FIRST_LIVE_SYMBOLS = "ETHUSDT"
