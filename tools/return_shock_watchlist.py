...
from tools.return_shock_alerts import build_payload as build_alert_payload
from tools.return_shock_state import build_state_payload
...
def _build_banner(summary: Dict[str, Any], top_summary: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "headline": f"Return shock watchlist top={symbol or 'none'} level={level} freshness={freshness} action={action}",
    ...
    *,
    ...
    for raw_symbol in symbols:
        ...
        alert_payload = build_alert_payload(
            ...
            out_json=f"reports/{symbol}_RETURN_SHOCK_ALERTS.json",
            out_md=f"reports/{symbol}_RETURN_SHOCK_ALERTS.md",
        )
        state_payload = build_state_payload(
            alert_payload=alert_payload,
            source_json=f"reports/{symbol}_RETURN_SHOCK_ALERTS.json",
            out_json=f"reports/{symbol}_RETURN_SHOCK_STATE.json",
            out_md=f"reports/{symbol}_RETURN_SHOCK_STATE.md",
        )
...
def _parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Build a multi-symbol return shock watchlist.")
    ...
    p.add_argument("--out-json", default="reports/RETURN_SHOCK_WATCHLIST.json")
    p.add_argument("--out-md", default="reports/RETURN_SHOCK_WATCHLIST.md")
