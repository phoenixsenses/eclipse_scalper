...
class CiWorkflowTests(unittest.TestCase):
    def test_ci_workflow_contains_required_chaos_gate_and_pr_comment(self):
        ...
        required = [
            ...
            "Run syntax/import compatibility smoke",
            "py_compile ok:",
            "import ok:",
            "tools.telemetry_dashboard_page",
            "tools.telemetry_alert_summary",
            "tools.telemetry_dashboard_notify",
            "execution.reliability_gate_runtime",
